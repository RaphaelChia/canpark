    ...
    return (
        <div className={styles.container}>
            ...
            <form className={styles.searchbar} onSubmit = {(e)=>{e.preventDefault()}}>
                <input onFocus={()=>setHideFilteredResult(false)} onBlur={()=>setToolTipStreetSpelling(false)} onChange={showStreetSpellingToolTip} autoComplete="off" type="text" placeholder="Search for a carpark" name ="search_keyword" onKeyUp={setKeyword_debounce} />  
